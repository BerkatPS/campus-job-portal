...
const MessageShow = ({ conversation }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('candidate.messages.reply', conversation.id), {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const handleArchive = () => {
        ...
        window.Inertia.put(route('candidate.messages.toggle-archive', conversation.id), {}, {
            preserveScroll: true,
        });
    };
    ...
    const isCurrentUserMessage = (message) => {
        return message.sender_id === conversation.candidate_id;
    };
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {message.attachment && (
                                                    <Box sx={{ mt: 2 }}>
                                                        <Button
                                                            href={route('candidate.messages.download-attachment', message.id)}
                                                            variant="outlined"
                                                            size="small"
