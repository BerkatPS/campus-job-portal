...
const Edit = ({ review, company, jobApplication }) => {
    const theme = useTheme();
    const isMobile = useMediaQuery(theme.breakpoints.down('sm'));

    const { data, setData, put, processing, errors } = useForm({
        job_application_id: review.job_application_id,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('candidate.reviews.update', review.id));
    };
    ...
    return (
        <Layout>
            <Head title="Edit Ulasan Perusahaan" />
                ...
                >
                    <Grid container spacing={4}>
                        <Grid item xs={12} md={4}>
                            <Card sx={{ position: 'sticky', top: 24, mb: 3, borderRadius: '1rem', border: '1px solid', borderColor: 'divider' }}>
                                <CardContent>
                                    ...
                                    <Typography variant="body2" color="text.secondary">
                                        Anda dapat mengubah penilaian atau ulasan yang telah Anda berikan.
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Grid>
                        ...
                        <Grid item xs={12} md={8}>
                            ...
                            >
                                <Typography variant="h5" gutterBottom fontWeight={600}>
                                    Edit Ulasan untuk {company.name}
                                </Typography>
                                <Typography variant="body2" color="text.secondary" sx={{ mb: 4 }}>
                                    Perbarui pengalaman dan pendapat Anda tentang perusahaan.
                                </Typography>
