...
const NotificationsPage = () => {
    ...
    const handleMarkAllAsRead = () => {
        ...
        router.post(route('manager.notifications.mark-all-as-read'), {}, {
            onSuccess: () => {
    ...
    const handleMarkAsRead = (id) => {
        ...
        router.post(route('manager.notifications.mark-as-read', id), {}, {
            onSuccess: () => {
                // Update UI setelah berhasil
                setCurrentNotifications(currentNotifications.map(notification =>
    ...
    const handleDelete = (id) => {
        ...
        router.delete(route('manager.notifications.destroy', id), {}, {
            onSuccess: () => {
                // Update UI setelah berhasil
    ...
    const handlePageChange = (event, page) => {
        router.visit(route('manager.notifications.index', { page }), {
            preserveState: true,
            only: ['notifications']
        });
    };
                    ...
                    <Card variant="outlined" sx={{ borderRadius: 2 }}>
                        <CardContent>
                            ...
                            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                                Sebagai administrator, Anda dapat mengatur jenis notifikasi yang dikirim ke pengguna. Anda juga dapat melihat riwayat notifikasi sistem di sini.
                            </Typography>
                            <Button
                                variant="contained"
                                color="primary"
